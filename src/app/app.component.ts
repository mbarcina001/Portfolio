...
export class AppComponent {
	...
	listaTrayectorias: Trayectoria[] = [
		new Trayectoria(
		  ...
		  '2011-2016',
		  `<p>Durante la carrera desarrollé gran parte de mis aptitudes actuales. Aprendí diversos lenguajes de programación
		...
		new Trayectoria(
		  ...
		  'Programador',
		  '2017-2018',
		  `<p>En esta empresa hice labores de mantenimiento de los proyectos web ya existentes dedicados a ofrecer servicio a
		...
		new Trayectoria(
		  ...
		  'Programador',
		  '2019',
		  `<p>Realicé el proyecto <span class='font-weight-bold'>FMS (Field Management Services)</span>, una aplicación
		  multiplataforma para Android, iOS y navegador implementada mediante Angular 6, Ionic 3 y Cordova.</p>
		  <p>Una vez finalizado dicho proyecto, me incorporé al desarrollo de una web para
		  <span class='font-weight-bold'>Celsa</span> implementada en AngularJS, con el uso de Gulp para el preprocesado
		  de los estilos y los scripts, y Protractor para los tests unitarios.</p>
		  <p>También he estado involucrado en la maquetación de la nueva página web de
		  <span class='font-weight-bold'>Booker</span> (HTML5, CS3 y Bootstrap).</p>`,
	...
	proyectos: Proyecto[] = [
		...
		new Proyecto(
			'p4',
			'Getronics FMS',
			`Aplicación multiplataforma para Android, iOS y navegadores destinada a su uso por parte de los técnicos de campo de Getronics.
		...
		, new Proyecto(
			'p7',
			'Eccairs 2',
			`Aplicación para la recopilación de incidencias en aviación y la gestión de la taxonomía empleada en los informes que
	...
	proyectosCarrera: Proyecto[] = [
		...
		new Proyecto(
			...
			`Aplicación que emplea técnicas de minería de datos (aprendizaje semisupervisado y evaluación no supervisada)
	...
	otrosProyectos: Proyecto[] = [
		...
		new Proyecto(
			...
			'gitlink',
			'https://github.com/mbarcina001/springmarket'
		),
		new Proyecto(
			'op4',
			'Kraken',
			'Aplicación web para gestión de agenda',
			[
			...
			'gitlink',
			'https://github.com/mbarcina001/kraken'
		)
	];
